...
@section('content')
    ...
    <div class="container">
            <h1>게시글 수정폼</h1>
        <div class="jumbotron">
            <form method="post" action="{{ action('BoardController@update') }}">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="content_loc" class="form-control" value="{{ $contents->content_loc }}">
                    <small class="form-text text-muted">update your location please.</small>
                </div>
